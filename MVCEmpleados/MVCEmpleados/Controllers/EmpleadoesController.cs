...
namespace MVCEmpleados.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        {
            var appDbContext = _context.Empleados.Include(e => e.Departamento);
        ...
        public async Task<IActionResult> Create([Bind("EmpleadoId,Nombre,FechaNacimiento,FechaContratacion,DepartamentoId,Salario,Descripcion")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmpleadoId,Nombre,FechaNacimiento,FechaContratacion,DepartamentoId,Salario,Descripcion")] Empleado empleado)
        {
            ModelState.Remove("Departamento"); 
